...
function SignInput(props) {
    const {setId, setPW, setPwCheck, setNick, setGender, setEmail, setPhoneNum, setAgree, onClick} = props;
    return (
        <>
            <div className={stl.Container}>
                <form>
                    ...
                    <Input id={"ChecksetNick"} label={"닉네임"} type={"text"} setData={setNick}/>
                    <InputRadio name={"gender"} Lvalue={"women"} Rvalue={"men"} Lname={"women"} Rname={"men"} setAgree={setGender}/>
                    <Input id={"setEmail"} label={"Emil"} type={"text"} setData={setEmail}/>
                    <Input id={"setPhoneNum"} label={"전화번호"} type={"text"} setData={setPhoneNum}/>
                    <InputRadio name={"agree"} Lvalue={"true"} Rvalue={"false"} Lname={"동의"} Rname={"비동의"} setAgree={setAgree}/>
